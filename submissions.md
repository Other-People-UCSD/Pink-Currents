...
* Written works: PDFs in Standard Manual Format with **all personally identifiable information REMOVED (from file name as well as from the text)**. Only the title, word count, and story/poem should be contained in the PDF.
